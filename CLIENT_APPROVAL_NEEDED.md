# Kauaʻi Drip — remaining client approvals

The preview uses the information Ashley has already provided. The following items remain intentionally unpublished or provisional until confirmed.

## Business and arrival details

1. Confirm the clinic's current public hours; the existing website, Jane, and Google listing have shown conflicting schedules.
2. Confirm whether an elevator is available and whether any additional arrival guidance should accompany the confirmed north-end wheelchair-accessible ramp and free parking.
3. Confirm whether the logo tagline should remain “IV Hydration & Wellness” or reflect the broader health-optimization practice.

## Team, services and photography
...
5. Provide or approve new clinic, provider, consultation, and treatment photographs. The preview temporarily uses images from the current website and Jane.
   - Neutral editorial supporting images (`body-composition.webp`, `wellness-vials.webp`, `body-composition-editorial.webp`, and `peptide-consultation-editorial.webp`) were created specifically for the preview. They contain no people and do not depict Kauaʻi Drip’s actual clinic, inventory, medication, or equipment. Replace or approve them before launch.
...
9. Approve all service prices before a public price menu is added.
10. Confirm HRT and IV membership inclusions, billing and cancellation terms, and eligibility requirements.
